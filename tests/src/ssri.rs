...
// Get outpoint from deployment record
const PASUABLE_UDT_TX_HASH: &str =
    "0x107562d1afa3fad33f08caf222922071165c95811a7f8b394f5914e08e40f8ad";
...
async fn test_get_methods() {
    ...
    let payload = json!({
        ...
        "params": [
            PASUABLE_UDT_TX_HASH,
            0,
            [get_methods_path_hex, "0x0000000000000000", "0x0000000000000000"] // Get all methods
        ]
    });
    ...
    let result_string =
        String::from(response_json["result"]["content"].as_str().unwrap())[2..].to_string();
    ...
    let methods_count = u32::from_le_bytes(decoded_result[..4].try_into().unwrap());
    ...
    let method_u64_vector = decode_u64_vector(&decoded_result[4..]).unwrap();
